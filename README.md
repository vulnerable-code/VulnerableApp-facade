...
by executing command: ```docker build . -t sasanlabs/owasp-vulnerableapp-facade:latest``` and then run the project as mentioned at [How to run the project](#how-to-run-the-project) 
